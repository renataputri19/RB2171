    ...
    <div class="space-y-4">
        ...
        <select id="section-select" 
         ...
         <div id="mekanisme-pengendalian" class="section hidden">
            @livewire('manage-criteria', ['selectedCategory' => 'Mekanisme Pengendalian'])
        </div>
        <div id="penanganan-pengaduan-masyarakat" class="section hidden">
            @livewire('manage-reform', ['selectedCategory' => 'Penanganan Pengaduan Masyarakat'])
        </div>
        <div id="penyampaian-laporan-harta-kekayaan" class="section hidden">
            @livewire('manage-reform', ['selectedCategory' => 'Penyampaian Laporan Harta Kekayaan'])
        </div>
