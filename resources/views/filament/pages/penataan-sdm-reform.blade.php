<x-filament::page>
    <div class="space-y-4">
        ...
        <div id="kinerja-individu" class="section hidden">
            @livewire('manage-criteria', ['selectedCategory' => 'Kinerja Individu'])
        </div>
        <div id="assessment-pegawai" class="section hidden">
            @livewire('manage-criteria', ['selectedCategory' => 'Assessment Pegawai'])
        </div>
        <div id="pelanggaran-disiplin" class="section hidden">
            @livewire('manage-reform', ['selectedCategory' => 'Pelanggaran Disiplin Pegawai'])
        </div>
