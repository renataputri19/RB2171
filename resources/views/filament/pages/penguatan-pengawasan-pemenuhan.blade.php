<x-filament::page>
    <div class="space-y-4">
        ...
        <div id="pengendalian-gratifikasi" class="section hidden">
            @livewire('manage-criteria', ['selectedCategory' => 'Pengendalian Gratifikasi'])
        </div>

        <div id="penerapan-spip" class="section hidden">
            @livewire('manage-criteria', ['selectedCategory' => 'Penerapan SPIP'])
        </div>

        <div id="pengaduan-masyarakat" class="section hidden">
            @livewire('manage-criteria', ['selectedCategory' => 'Pengaduan Masyarakat'])
        </div>

        <div id="whistle-blowing-system" class="section hidden">
            @livewire('manage-criteria', ['selectedCategory' => 'Whistle-Blowing System'])
        </div>

        <div id="penanganan-benturan-kepentingan" class="section hidden">
            @livewire('manage-criteria', ['selectedCategory' => 'Penanganan Benturan Kepentingan'])
        </div>
