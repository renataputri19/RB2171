<x-filament::page>
    <div class="space-y-4">
        ...
        <div id="perencanaan-kebutuhan" class="section hidden">
            @livewire('manage-criteria', ['selectedCategory' => 'Perencanaan Kebutuhan Pegawai'])
        </div>

        <div id="pola-mutasi-internal" class="section hidden">
            @livewire('manage-criteria', ['selectedCategory' => 'Pola Mutasi Internal'])
        </div>

        <div id="pengembangan-pegawai" class="section hidden">
            @livewire('manage-criteria', ['selectedCategory' => 'Pengembangan Pegawai'])
        </div>

        <div id="penetapan-kinerja-individu" class="section hidden">
            @livewire('manage-criteria', ['selectedCategory' => 'Penetapan Kinerja Individu'])
        </div>

        <div id="penegakan-aturan" class="section hidden">
            @livewire('manage-criteria', ['selectedCategory' => 'Penegakan Aturan'])
        </div>

        <div id="sistem-informasi" class="section hidden">
            @livewire('manage-criteria', ['selectedCategory' => 'Sistem Informasi Kepegawaian'])
        </div>
