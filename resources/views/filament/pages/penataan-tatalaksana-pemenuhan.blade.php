<x-filament::page>
    <div class="space-y-4">
        ...
        <div id="prosedur-operasional" class="section hidden">
            @livewire('manage-criteria', ['selectedCategory' => 'Prosedur Operasional Tetap (SOP) Kegiatan Utama'])
        </div>

        <div id="sistem-pemerintahan" class="section hidden">
            @livewire('manage-criteria', ['selectedCategory' => 'Sistem Pemerintahan Berbasis Elektronik (SPBE)'])
        </div>

        <div id="keterbukaan-informasi" class="section hidden">
            @livewire('manage-criteria', ['selectedCategory' => 'Keterbukaan Informasi Publik'])
        </div>
