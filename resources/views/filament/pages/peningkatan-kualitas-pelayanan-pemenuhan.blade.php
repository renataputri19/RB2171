<x-filament::page>
    <div class="space-y-4">
        ...
        <div id="standar-pelayanan" class="section hidden">
            @livewire('manage-criteria', ['selectedCategory' => 'Standar Pelayanan'])
        </div>

        <div id="budaya-pelayanan-prima" class="section hidden">
            @livewire('manage-criteria', ['selectedCategory' => 'Budaya Pelayanan Prima'])
        </div>

        <div id="pengelolaan-pengaduan" class="section hidden">
            @livewire('manage-criteria', ['selectedCategory' => 'Pengelolaan Pengaduan'])
        </div>

        <div id="penilaian-kepuasan" class="section hidden">
            @livewire('manage-criteria', ['selectedCategory' => 'Penilaian Kepuasan'])
        </div>

        <div id="pemanfaatan-teknologi" class="section hidden">
            @livewire('manage-criteria', ['selectedCategory' => 'Pemanfaatan Teknologi Informasi'])
        </div>
