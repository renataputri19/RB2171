    ...
    <div class="space-y-4">
        ...
        <div id="upaya-inovasi" class="section hidden">
            ...
            <div class="mb-6">
                ...
                @livewire('manage-criteria', ['selectedCategory' => 'Peningkatan Kualitas Pelayanan Publik - Criteria'])
            </div>
            ...
            <div class="mt-6">
                ...
                @livewire('manage-reform', ['selectedCategory' => 'Peningkatan Kualitas Pelayanan Publik - Reform'])
            </div>
        </div>

        <div id="pengaduan-konsultasi" class="section hidden">
            @livewire('manage-criteria', ['selectedCategory' => 'Penanganan Pengaduan Pelayanan dan Konsultasi'])
        </div>
