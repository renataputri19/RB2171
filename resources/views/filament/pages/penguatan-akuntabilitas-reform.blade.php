<x-filament::page>
    <div class="space-y-4">
        ...
        <div id="meningkatnya-capaian-kinerja-unit-kerja" class="section hidden">
            @livewire('manage-reform', ['selectedCategory' => 'Meningkatnya Capaian Kinerja Unit Kerja'])
        </div>
        <div id="pemberian-reward-and-punishment" class="section hidden">
            @livewire('manage-criteria', ['selectedCategory' => 'Pemberian Reward and Punishment'])
        </div>
        <div id="kerangka-logis-kinerja" class="section hidden">
            @livewire('manage-criteria', ['selectedCategory' => 'Kerangka Logis Kinerja'])
        </div>
