<x-filament::page>
    <div class="space-y-4">
        ...
        <div id="peta-proses-bisnis" class="section hidden">
            @livewire('manage-criteria', ['selectedCategory' => 'Peta Proses Bisnis Mempengaruhi Penyederhanaan Jabatan'])
        </div>
        <div id="sistem-pemerintahan-spbe" class="section hidden">
            @livewire('manage-criteria', ['selectedCategory' => 'Sistem Pemerintahan Berbasis Elektronik (SPBE) yang Terintegrasi'])
        </div>
        <div id="transformasi-digital" class="section hidden">
            @livewire('manage-criteria', ['selectedCategory' => 'Transformasi Digital Memberikan Nilai Manfaat'])
        </div>
