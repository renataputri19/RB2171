<x-filament::page>
    <div class="space-y-4">
        ...
        <div id="penyusunan-tim-kerja" class="section hidden">
            @livewire('manage-criteria', ['selectedCategory' => 'Penyusunan Tim Kerja'])
        </div>
        <div id="rencana-pembangunan-zi" class="section hidden">
            @livewire('manage-criteria', ['selectedCategory' => 'Rencana Pembangunan Zona Integritas'])
        </div>
        <div id="pemantauan-evaluasi" class="section hidden">
            @livewire('manage-criteria', ['selectedCategory' => 'Pemantauan dan Evaluasi Pembangunan WBK/WBBM'])
        </div>
        <div id="perubahan-budaya-kerja" class="section hidden">
            @livewire('manage-criteria', ['selectedCategory' => 'Perubahan Pola Pikir dan Budaya Kerja'])
        </div>
